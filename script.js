...
const taskData =  JSON.parse(localStorage.getItem('data'))|| [];//array to store all the tasks along with their associated data.This storage will enable you to keep track of tasks, display them on the page, and save them to localStorage.

let currentTask = {};//object to store the current task that is being edited or added.
...
taskForm.addEventListener('submit', (e) => {
    e.preventDefault();//to prevent the browser from reloading the page when the form is submitted.
    addOrUpdateTask();
